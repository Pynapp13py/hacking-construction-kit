...
static const SERVER_ROUTINE srvsvc_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)func0,
    (SERVER_ROUTINE)func1,
    (SERVER_ROUTINE)func2,
    (SERVER_ROUTINE)func3,
    (SERVER_ROUTINE)func4,
    (SERVER_ROUTINE)func5,
    (SERVER_ROUTINE)func6,
    (SERVER_ROUTINE)func7,
    (SERVER_ROUTINE)func8,
    (SERVER_ROUTINE)func9,
    (SERVER_ROUTINE)func0a,
    (SERVER_ROUTINE)func0b,
    (SERVER_ROUTINE)func0c,
    (SERVER_ROUTINE)func0d,
    (SERVER_ROUTINE)func0e,
    (SERVER_ROUTINE)func0f,
    (SERVER_ROUTINE)func10,
    (SERVER_ROUTINE)func11,
    (SERVER_ROUTINE)func12,
    (SERVER_ROUTINE)func13,
    (SERVER_ROUTINE)func14,
    (SERVER_ROUTINE)func15,
    (SERVER_ROUTINE)func16,
    (SERVER_ROUTINE)func17,
    (SERVER_ROUTINE)func18,
    (SERVER_ROUTINE)func19,
    (SERVER_ROUTINE)func1a,
    (SERVER_ROUTINE)func1b,
    (SERVER_ROUTINE)srvsvc_NetRemoteTOD,
    (SERVER_ROUTINE)func1d,
    (SERVER_ROUTINE)func1e,
    (SERVER_ROUTINE)srvsvc_NetprPathCanonicalize,
    (SERVER_ROUTINE)func20,
    (SERVER_ROUTINE)func21,
    (SERVER_ROUTINE)func22,
    (SERVER_ROUTINE)func23
    };
