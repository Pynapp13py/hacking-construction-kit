...
static const RPC_CLIENT_INTERFACE spoolss___RpcClientInterface =
    {
...
RPC_IF_HANDLE spoolss_v1_0_c_ifspec = (RPC_IF_HANDLE)& spoolss___RpcClientInterface;

extern const MIDL_STUB_DESC spoolss_StubDesc;

RPC_BINDING_HANDLE spoolss__MIDL_AutoBindHandle = 0;
    ...
    /* [ref][out] */ long *returned)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&spoolss_StubDesc,
...
static const MIDL_STUB_DESC spoolss_StubDesc = 
    {
    (void *)& spoolss___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &spoolss__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
